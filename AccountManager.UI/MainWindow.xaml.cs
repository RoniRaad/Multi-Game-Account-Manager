...
namespace AccountManager.UI
{
	...
	public partial class MainWindow : Window
    {
		...
		private void TrySetVersionNumber()
		{
            try
            {
                if (File.Exists("Multi-Account-Manager-Experimental-Experimental.exe.manifest"))
                {
                    var assembly = XElement.Load("Multi-Account-Manager-Experimental-Experimental.exe.manifest");
